...
/// Home page showing task list with all the LAG problems.
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('📋 Traditional Task Manager'),
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            child: Text(
              '⚠️ This app demonstrates PROBLEMS. Try clicking buttons rapidly!',
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Search tasks... (type fast to see race condition)',
          prefixIcon: const Icon(Icons.search),
          border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
          suffixIcon: BlocBuilder<TaskCubit, TaskState>(
            builder: (context, state) {
          ...
          child: ListView(
            ...
            children: [
              FilterChip(
                ...
                onSelected: (_) => context.read<TaskCubit>().setCategoryFilter(null),
              ),
              ...
              ...state.categories.map((cat) => Padding(
                    ...
                    child: FilterChip(
                      ...
                      onSelected: (_) => context.read<TaskCubit>().setCategoryFilter(cat.id),
                    ),
                  )),
            ],
          ),
      ...
      builder: (context, state) {
        return Padding(
          ...
          child: Wrap(
            ...
            runSpacing: 8,
            children: [
              // RACE CONDITION DEMO: Click rapidly!
              ElevatedButton.icon(
                onPressed: state.isLoading ? null : () => context.read<TaskCubit>().fetchTasks(),
              ...
              ElevatedButton.icon(
                onPressed: () => context.read<TaskCubit>().refreshAll(),
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                ElevatedButton(onPressed: () => context.read<TaskCubit>().fetchTasks(), child: const Text('Retry')),
              ],
            ),
          );
        }
            ...
            builder: (context, state) {
              return ElevatedButton(
                onPressed: state.isCreating ? null : () {
                  final task = Task(id: '', title: titleController.text, description: descController.text, categoryId: 'work', createdAt: DateTime.now());
